...
export default function TaskCard({
  ...
  return (
    <div className="flex flex-col gap-1 bg-white rounded-md border border-gray-400 p-3 tablet:flex-row tablet:items-center tablet:gap-5 tablet:p-5 pc:flex-col pc:items-stretch pc:gap-4 pc:px-5 pc:py-4">
      {imageUrl && (
